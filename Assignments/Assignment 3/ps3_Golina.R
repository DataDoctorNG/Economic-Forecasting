...
#
#
#This creates a plot comapring the Naive Seasonality Model (indicated in green) forecast to the original 
#plot for fortified wine sales. Some of the slight breaks in cyclical patterms
...
#
#
#This creates a correlogram for x. The graph seems to demonstrate autcorrelation 
