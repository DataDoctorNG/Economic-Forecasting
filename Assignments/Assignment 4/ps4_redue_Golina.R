...
#
#
#This defines an object as a time series of x1 and soome lag variables as well.
...
#The value of the MAPE of the Naive model with trend is 6872.09 and the value from the NAIVE model is 3372.184. 

NaivetrendMAPEtsx1 <- mean(abs((tsx1 - yhatNaivetsx1)/tsx1))*100
print(NaivetrendMAPEtsx1) 

NaiveMAPEtsx1 <- mean(abs((tsx1 - tsx1.lag1)/tsx1))*100
print(NaiveMAPEtsx1) 
...
#
#
#This detrends tsx2 and stores the result into an object and creates lagged versions of it.



x.tilde <- (tsx2 - ((tsx2 - tsx2.lag1)/tsx2))
...
plot(x.tilde, main="Plot of the Detrended x2 over a time series", col="red")
...
#
#
#This creates the MAPE for tsx2 and prints it. The value of the MAPE is 15.07969 
...
NaiveMAPEtsx2 <- mean(abs((tsx2 - yhatNaivetrendtsx2)/tsx2))*100
print(NaiveMAPEtsx2) 
...
#
#
#This creates an acf plot for tsx3. The acf plot definietly suggests stationarity and the plot of the time series
...
#
#
#This calculates the MAPE for the AR model. The value for the MAPE is 160.4879.

ARMAPEtsx3 <- mean(abs(ARResidtsx3/tsx3))*100
print(ARMAPEtsx3) 

#
#
#This calculates the MAPE for the ARIMA model. The value for the MAPE is 155.7582. This means that 
#in technical terms the ARIMA model of the 2nd order is better. 

ARIMAMAPEtsx3 <- mean(abs(ARIMAResidtsx3/tsx3))*100
print(ARIMAMAPEtsx3) 
